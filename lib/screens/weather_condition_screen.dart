  ...
  Future<void> _fetchWeather() async {
    ...
    try {
      ...
      if (cur != null && idx != -1) {
        ...
        final double hum = (hourly['relative_humidity_2m'][idx] as num).toDouble();
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildField('Wind Speed (km/h)', _windSpeedController),
                        _buildField('Temperature (°C)', _temperatureController),
                        _buildField('Humidity (%)', _humidityController),
                        _buildField('Precipitation (mm)', _precipitationController),
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          ...
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (_) => SlingConfigurationScreen(),
                              settings: RouteSettings(arguments: weatherData),
                            ),
                          );
                        },
